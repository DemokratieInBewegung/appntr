...
LOOMIO_INCOMING_GROUP = int(os.environ.get("LOOMIO_INCOMING_GROUP", "56603"))
LOOMIO_REJECTED_GROUP = int(os.environ.get("LOOMIO_REJECTED_GROUP", "56603"))
LOOMIO_ACCEPTED_GROUP = int(os.environ.get("LOOMIO_ACCEPTED_GROUP", "56603"))
LOOMIO_BACKBURNER_GROUP = int(os.environ.get("LOOMIO_BACKBURNER_GROUP", LOOMIO_ACCEPTED_GROUP))
